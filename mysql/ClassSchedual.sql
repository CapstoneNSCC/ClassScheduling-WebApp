...
CREATE TABLE IF NOT EXISTS TblCourse (
    ...
    PRIMARY KEY (Id),
    FOREIGN KEY (IdProfessor) REFERENCES TblUser(Id) ON DELETE NO ACTION ON UPDATE NO ACTION,
    FOREIGN KEY (IdProgram) REFERENCES TblProgram(Id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE IF NOT EXISTS TblTechClass (
    ...
    FOREIGN KEY (IdCourse) REFERENCES TblCourse(Id) ON DELETE NO ACTION ON UPDATE NO ACTION,
    FOREIGN KEY (IdTechnology) REFERENCES TblTechnology(Id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
CREATE TABLE IF NOT EXISTS TblTechRoom (
    ...
    FOREIGN KEY (IdClassroom) REFERENCES TblClassroom(Id) ON DELETE NO ACTION ON UPDATE NO ACTION,
    FOREIGN KEY (IdTechnology) REFERENCES TblTechnology(Id) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB DEFAULT CHARSET = latin1;
...
VALUES
    (
        ...
        TRUE,
        'user',
        'V3wjYKvYBnCwEn6wIR1HDJbP+P1dz+pgyDbb2UlI95s=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Pablo',
        'Santos',
        TRUE,
        'pablo',
        'GWftrhCl31KH54HIo5pDKBOZCRDdjxtLxq571rJuycA=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Kayla',
        ...
        TRUE,
        'kayla',
        'TS2OQQ7XOGnvq9C/aS4WNiiGAdMz8osde8xBQl6JvsU=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Dylan',
        ...
        TRUE,
        'dylan',
        'HCYHoaYJWGyduzsHuU6+s+dsAofaGClontE/t5blwak=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Sean',
        ...
        FALSE,
        'sean',
        'nNKacirUadrGD9npbzM3FpdqobbNucxXwq9TDPHaG7Q=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Gordon',
    ...
    (
        ...
        FALSE,
        'ryan',
        'AdWTSk6URrGZIonKcPpAecHm5XFGAEcNAT7G32Hf308=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Matthew',
        ...
        FALSE,
        'matt',
        'gljYbbgsHhLCVHk1SHmEubC8GOzp/c4lDZyULueMr3o=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    ),
    (
        'Hyesun',
    ...
    (
        ...
        FALSE,
        'test',
        'iBffC45HMekQwUMnYq4aoZulUda+pCpV379Rznrrf1A=',
        '0w54NUgsGa53PfCmOt9Lhg=='
    );
...
INSERT INTO
    TblClassroom (RoomNumber, BuildingAcronym)
VALUES
    (308, 'TRF'),
    (312, 'TRF'),
    (309, 'TRF'),
...
INSERT INTO
    TblCourse (Code, Name, Hours, IdProfessor, IdProgram)
VALUES
