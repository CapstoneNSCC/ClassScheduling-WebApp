function startAutoLogout() {
  // setup timeout that will occur when session has expired (120 minutes = 60000 * 120 milliseconds)
  window.setTimeout(() => document.location = "/", 7200000);
  // setup timeout that will occur when session about to expire to warn user
  window.setTimeout(() => document.getElementById("lblExpire").innerHTML = "WARNING : Session is about to expire!", 7080000);
}
